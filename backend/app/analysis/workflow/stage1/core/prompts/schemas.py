...
_BAR_REF: dict = {
    "type": "object",
    "required": ["bar_timestamp", "timeframe", "session", "day_index"],
    "properties": {
        "bar_timestamp": {"type": "string", "format": "date-time"},
        "timeframe": {"type": "string", "minLength": 1},
        "session": {"type": "string", "enum": ["CME", "US_EQUITY_RTH"]},
...
_BAR_RANGE: dict = {
    "type": ["object", "null"],
    "required": ["start", "end"],
    "properties": {"start": _BAR_REF, "end": _BAR_REF},
    "additionalProperties": False,
}
...
_SIGNAL_BAR: dict = {
    "type": "object",
    "required": ["bar_ref", "quality", "reason"],
    "properties": {
        "bar_ref": {"anyOf": [_BAR_REF, {"type": "null"}]},
...
_DECISION_BASE: dict = {
    ...
    "properties": {
        ...
        "entry_basis_bar": {"anyOf": [_BAR_REF, {"type": "null"}]},
...
from app.analysis.workflow.stage1.core.compat import CYCLE_ENUM as _CYCLE_ENUM  # noqa: E402
