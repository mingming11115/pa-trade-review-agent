...
Implements 使用说明 order-routing table exactly.
...
from app.analysis.workflow.stage1.core.pattern_routing import merge_detected_patterns
...
def _channel_files(direction: str) -> list[str]:
    ...
    if direction == "bullish":
        ...
        # range strategy for boundary planned-limit setups (signal_bar_quality path).
        logger.info(
